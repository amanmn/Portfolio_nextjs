      ...
      <div className="container" ref={scope}>
        ...
        <div className='mt-20 flex flex-col gap-8'>
          <div className="grid grid-cols-1 gap-8 md:grid-cols-5 lg:grid-cols-3">
            <Card
              className='h-[320px] md:col-span-2 lg:col-span-1 fade-item'
            ...
            <Card
              className='h-[320px] md:col-span-3 lg:col-span-2 fade-item'
              style={{ opacity: 0, transform: 'translateY(0%)' }}
            >
              <CardHeader
                title="My Toolbox"
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 lg:grid-cols-3 gap-8 ">
            <Card
              className='h-[320px] p-0 flex flex-col md:col-span-3 lg:col-span-2 fade-item'
              style={{ opacity: 0, transform: 'translateY(0%)' }}
            >
              <CardHeader
            ...
            <Card
              className='h-[320px] p-0 relative md:col-span-2 lg:col-span-1 fade-item'
